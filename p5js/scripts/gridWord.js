...
function draw() {
  ...
  fill(outerColor(4));
  rect(83, 90, 90, 90, 20, 20, 20, 20); //  (0,0)
  fill(outerColor(5));
  rect(83, 180, 90, 90, 20, 20, 20, 20); // (1,0)
  fill(outerColor(6));
  rect(83, 270, 90, 90, 20, 20, 20, 20); // (2,0)

  fill(toughColor(0));
  rect(173, 90, 90, 90, 20, 20, 20, 20); //  (0,1)
  fill(innerColor());
  rect(173, 180, 90, 90, 20,20,20,20); //  (1,1)
  fill(outerColor(3));
  rect(173, 270, 90, 90, 20, 20, 20, 20); // (2,1)

  fill(toughColor(1));
  rect(263, 90, 90, 90, 20, 20, 20, 20); // (0,2)
  fill(outerColor(1));
  rect(263, 180, 90, 90, 20, 20, 20, 20); // (1,2)
  fill(outerColor(2));
  rect(263, 270, 90, 90, 20, 20, 20, 20); // (2,2)
